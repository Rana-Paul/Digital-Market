...
var addUser = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            user = req.user;
            return [2 /*return*/, __assign(__assign({}, data), { user: user === null || user === void 0 ? void 0 : user.id })];
        });
    });
};
    ...
    hooks: {
        ...
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var data, createdProduct, updated, data, updatedStripeProduct, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            updated = __assign(__assign({}, data), { stripeId: updatedStripeProduct.id, priceId: updatedStripeProduct.default_price });
                            return [2 /*return*/, updated];
